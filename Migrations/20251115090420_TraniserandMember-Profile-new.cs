...
{
    /// <inheritdoc />
    public partial class TraniserandMemberProfilenew : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PerformanceCount = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastRatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    RatingBadge = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrainerProfile", x => x.TrainerId);
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 11, 15, 9, 4, 19, 638, DateTimeKind.Utc).AddTicks(2045), null, "Full-year plan with trainer and diet support", 12, true, "Gold", 12000m, null },
                    { 2, new DateTime(2025, 11, 15, 9, 4, 19, 638, DateTimeKind.Utc).AddTicks(2048), null, "Half-year plan with trainer support", 6, true, "Silver", 7000m, null },
                    { 3, new DateTime(2025, 11, 15, 9, 4, 19, 638, DateTimeKind.Utc).AddTicks(2050), null, "Quarterly plan for new members", 3, true, "Bronze", 4000m, null }
                });
